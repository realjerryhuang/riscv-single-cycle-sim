...
/* Given an address and instruction, store the instruction at that address. */
...
/* Given an address, return the instruction stored in the instruction memory at that address. */
